# Pokémon Bonds and Chains

Bienvenido al repositorio oficial de **Pokémon Bonds and Chains**, un proyecto intermodular desarrollado sobre RPG Maker XP y Pokémon Essentials v21.1. 
...
Para jugar y evaluar el proyecto, no es necesario instalar ningún motor ni programa adicional. Solo sigue estos pasos:

1. **Clonar el repositorio** o descargar el código haciendo clic en el botón verde `Code` -> `Download ZIP`.
2. Si lo descargaste como ZIP, **extrae la carpeta completa** en tu ordenador (muy importante: no abras el juego desde dentro del ZIP sin descomprimir).
3. Entra en la carpeta extraída y haz doble clic en el archivo **`Game.exe`** (o el ejecutable principal).
4. ¡Disfruta del juego!

* Nota técnica: El archivo `.exe` necesita leer las carpetas `Graphics`, `PBS` y `Data` para funcionar. Por favor
